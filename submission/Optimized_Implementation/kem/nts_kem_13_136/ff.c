...
void vector_ff_mul_13(const FF2m* ff2m, uint64_t* c, const uint64_t* a, const uint64_t* b)
{
    uint64_t t[13];
...
void vector_ff_sqr_13(const FF2m* ff2m, uint64_t* b, const uint64_t* a)
{
    b[12]  = a[11] ^ a[12];
    b[ 0]  = a[ 0] ^ a[11];
    b[ 1]  = b[12] ^ a[ 7];
...
void vector_ff_pow4_13(const FF2m* ff2m, uint64_t* b, const uint64_t* a)
{
    b[12]  = a[10] ^ a[11] ^ a[12];
    b[ 0]  = b[12] ^ a[ 0];
    b[ 1]  = a[ 6] ^ a[ 8] ^ a[11];
...
void vector_ff_pow8_13(const FF2m* ff2m, uint64_t* b, const uint64_t* a)
{
    b[ 7]  = a[10] ^ a[12];
...
void vector_ff_pow16_13(const FF2m* ff2m, uint64_t* b, const uint64_t* a)
{
    b[10]  = a[ 3] ^ a[ 4];
    b[12]  = a[ 8] ^ a[ 9] ^ a[10];
    b[ 0]  = a[ 8] ^ a[10] ^ a[11];
...
void vector_ff_inv_13(const FF2m* ff2m, uint64_t* b, const uint64_t* a)
{
    uint64_t a3[13], a15[13], t[13];
...
void vector_ff_sqr_inv_13(const FF2m* ff2m, uint64_t* b, const uint64_t* a)
{
    uint64_t a3[13], a15[13], t[13];

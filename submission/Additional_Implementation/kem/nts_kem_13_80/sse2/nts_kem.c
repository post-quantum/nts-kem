                        ...
                        uint8_t *k_r)
{
    ...
    __m128i vec_syndromes[2][NTS_KEM_PARAM_M] = {{{0}}};
    __m128i sigma[1][NTS_KEM_PARAM_M];
                            ...
                            ff_unit *h)
{
     ...
     **/
    vector_load_1d_128(g[0], Gz->coeff, (NTS_KEM_PARAM_T+1));
    bitslice_fft(vh, g);
